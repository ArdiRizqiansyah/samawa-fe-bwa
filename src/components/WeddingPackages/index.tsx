...
type PropsWeeddingPackageWrapper = {
    show: TShow;
    type: "grid" | "slider";
};
    ...
    return (
        <div className="relative">
            <Slider
                ...
                swipperSliderClassName="-mx-10 px-12 xl:max-w-5xl 2xl:max-w-7xl"
            >
                {
                    data.map(slide => {
                        return (
                            <div key={slide.id} className="card-slide h-full rounded-3xl overflow-hidden relative">
...
async function WeddingPackageWrapper({
    show,
    type,
}: PropsWeeddingPackageWrapper) {
...
export default WeddingPackageWrapper;
